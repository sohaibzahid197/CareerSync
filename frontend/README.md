This is a [Next.js](https://nextjs.org/) project bootstrapped with [`create-next-server`](https://github.com/vercel/next.js/tree/canary/packages/create-next-server).
